...
class _ProfileManagementState extends State<ProfileManagement> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: const Text('Update Profile'), backgroundColor: Colors.green[300],foregroundColor: Colors.white),
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 40,
                                vertical: 10),
                                foregroundColor: Colors.white, // Adjust the padding for width
                            backgroundColor: Colors.green[300],
                            shape: RoundedRectangleBorder(
